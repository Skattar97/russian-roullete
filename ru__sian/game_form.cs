...
namespace ru__sian
{
    public partial class game_form : Form
    {
        ...
        {    // below code is for enableling and disableing the button
            ...
            pbox.Image = Image.FromFile(@"C:\Users\LENOVO\Desktop\ru__sian\res\load.gif");
        ...
        {             //below code is for sound and gif
            ...
            Image img = Image.FromFile(@"C:\Users\LENOVO\Desktop\ru__sian\res\spin.gif");
            pbox.Image = img;
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\LENOVO\Desktop\ru__sian\res\spin.wav");
            player.Play();
        ...
        private void Shooter_btn_Click(object sender, EventArgs e)
        {
            ...
            Image img = Image.FromFile(@"C:\Users\LENOVO\Desktop\ru__sian\res\shoot.gif");
            pbox.Image = img;
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\Users\LENOVO\Desktop\ru__sian\res\shoot.wav");
            player.Play();
